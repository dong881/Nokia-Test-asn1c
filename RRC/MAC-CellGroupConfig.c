...
asn_TYPE_descriptor_t asn_DEF_drx_ConfigRrc_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_drx_ConfigRrc_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_phr_Config_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_phr_Config_constr_8, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dataInactivityTimer_v1530_15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_dataInactivityTimer_v1530_constr_15, CHOICE_constraint },
