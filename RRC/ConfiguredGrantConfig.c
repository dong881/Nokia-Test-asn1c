...
asn_TYPE_descriptor_t asn_DEF_uci_OnPUSCH_12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_uci_OnPUSCH_constr_12, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_resourceAllocation_15 = {
	...
	{ 0, &asn_PER_type_resourceAllocation_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_rbg_Size_19 = {
	...
	{ 0, &asn_PER_type_rbg_Size_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_powerControlLoopToUse_21 = {
	...
	{ 0, &asn_PER_type_powerControlLoopToUse_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_transformPrecoder_25 = {
	...
	{ 0, &asn_PER_type_transformPrecoder_constr_25, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_repK_29 = {
	...
	{ 0, &asn_PER_type_repK_constr_29, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_repK_RV_34 = {
	...
	{ 0, &asn_PER_type_repK_RV_constr_34, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_periodicity_38 = {
	...
	{ 0, &asn_PER_type_periodicity_constr_38, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_rrc_ConfiguredUplinkGrant_85[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, timeDomainOffset),
		...
		0,
		{ 0, &asn_PER_memb_timeDomainOffset_constr_86,  memb_timeDomainOffset_constraint_85 },
		0, 0, /* No default value */
		"timeDomainOffset"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, timeDomainAllocation),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_timeDomainAllocation_constr_87,  memb_timeDomainAllocation_constraint_85 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, frequencyDomainAllocation),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_frequencyDomainAllocation_constr_88,  memb_frequencyDomainAllocation_constraint_85 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, antennaPort),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_antennaPort_constr_89,  memb_antennaPort_constraint_85 },
		0, 0, /* No default value */
		"antennaPort"
		},
	{ ATF_POINTER, 1, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, dmrs_SeqInitialization),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_dmrs_SeqInitialization_constr_90,  memb_dmrs_SeqInitialization_constraint_85 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, precodingAndNumberOfLayers),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_precodingAndNumberOfLayers_constr_91,  memb_precodingAndNumberOfLayers_constraint_85 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, srs_ResourceIndicator),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_srs_ResourceIndicator_constr_92,  memb_srs_ResourceIndicator_constraint_85 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, mcsAndTBS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_mcsAndTBS_constr_93,  memb_mcsAndTBS_constraint_85 },
		0, 0, /* No default value */
		"mcsAndTBS"
		},
	{ ATF_POINTER, 1, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, frequencyHoppingOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_frequencyHoppingOffset_constr_94,  memb_frequencyHoppingOffset_constraint_85 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig__rrc_ConfiguredUplinkGrant, pathlossReferenceIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_pathlossReferenceIndex_constr_95,  memb_pathlossReferenceIndex_constraint_85 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_ConfiguredGrantConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ConfiguredGrantConfig, nrofHARQ_Processes),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nrofHARQ_Processes_constr_28,  memb_nrofHARQ_Processes_constraint_1 },
		0, 0, /* No default value */
		"nrofHARQ-Processes"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct ConfiguredGrantConfig, configuredGrantTimer),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_configuredGrantTimer_constr_84,  memb_configuredGrantTimer_constraint_1 },
		0, 0, /* No default value */
