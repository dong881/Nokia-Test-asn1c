...
asn_TYPE_descriptor_t asn_DEF_pucch_Config_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pucch_Config_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_pusch_Config_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pusch_Config_constr_5, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_configuredGrantConfig_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_configuredGrantConfig_constr_8, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_srs_Config_11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_srs_Config_constr_11, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_beamFailureRecoveryConfig_14 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_beamFailureRecoveryConfig_constr_14, CHOICE_constraint },
