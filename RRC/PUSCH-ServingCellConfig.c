...
asn_TYPE_descriptor_t asn_DEF_codeBlockGroupTransmission_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_codeBlockGroupTransmission_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_rateMatching_5 = {
	...
	{ 0, &asn_PER_type_rateMatching_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_xOverhead_7 = {
	...
	{ 0, &asn_PER_type_xOverhead_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext1_12[] = {
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ServingCellConfig__ext1, maxMIMO_Layers),
		...
		0,
		{ 0, &asn_PER_memb_maxMIMO_Layers_constr_13,  memb_maxMIMO_Layers_constraint_12 },
		0, 0, /* No default value */
		"maxMIMO-Layers"
		},
