...
asn_TYPE_descriptor_t asn_DEF_gapSharingFR2_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_gapSharingFR2_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_gapSharingFR1_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_gapSharingFR1_constr_7, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_gapSharingUE_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_gapSharingUE_constr_10, CHOICE_constraint },
