...
asn_TYPE_descriptor_t asn_DEF_maxNumberSemiPersitentSRS_PerBWP_16 = {
	...
	{ 0, &asn_PER_type_maxNumberSemiPersitentSRS_PerBWP_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_SRS_Resources_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resources, maxNumberSP_SRS_PerBWP_PerSlot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSP_SRS_PerBWP_PerSlot_constr_22,  memb_maxNumberSP_SRS_PerBWP_PerSlot_constraint_1 },
		0, 0, /* No default value */
