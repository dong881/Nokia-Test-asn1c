...
asn_TYPE_descriptor_t asn_DEF_mux_SR_HARQ_ACK_CSI_PUCCH_33 = {
	...
	{ 0, &asn_PER_type_mux_SR_HARQ_ACK_CSI_PUCCH_constr_33, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_Phy_ParametersFRX_Diff_1[] = {
	...
	{ ATF_POINTER, 36, offsetof(struct Phy_ParametersFRX_Diff, oneFL_DMRS_TwoAdditionalDMRS),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_oneFL_DMRS_TwoAdditionalDMRS_constr_4,  memb_oneFL_DMRS_TwoAdditionalDMRS_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 34, offsetof(struct Phy_ParametersFRX_Diff, twoFL_DMRS_TwoAdditionalDMRS),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_twoFL_DMRS_TwoAdditionalDMRS_constr_6,  memb_twoFL_DMRS_TwoAdditionalDMRS_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 33, offsetof(struct Phy_ParametersFRX_Diff, oneFL_DMRS_ThreeAdditionalDMRS),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_oneFL_DMRS_ThreeAdditionalDMRS_constr_7,  memb_oneFL_DMRS_ThreeAdditionalDMRS_constraint_1 },
		0, 0, /* No default value */
