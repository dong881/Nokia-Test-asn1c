...
asn_TYPE_descriptor_t asn_DEF_csi_SSB_ResourceSetToAddReleaseList_20 = {
	...
	{ 0, &asn_PER_type_csi_SSB_ResourceSetToAddReleaseList_constr_20, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_aperiodicTriggerStateList_31 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_aperiodicTriggerStateList_constr_31, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_semiPersistentOnPUSCH_TriggerStateList_34 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_semiPersistentOnPUSCH_TriggerStateList_constr_34, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_MeasConfig_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct CSI_MeasConfig, csi_SSB_ResourceSetToAddReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_csi_SSB_ResourceSetToAddReleaseList_constr_20,  memb_csi_SSB_ResourceSetToAddReleaseList_constraint_1 },
		0, 0, /* No default value */
		"csi-SSB-ResourceSetToAddReleaseList"
		},
