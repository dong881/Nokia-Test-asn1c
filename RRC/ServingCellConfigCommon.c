...
asn_TYPE_descriptor_t asn_DEF_lte_CRS_ToMatchAround_26 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_lte_CRS_ToMatchAround_constr_26, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_rateMatchPatternToAddModList_29 = {
	...
	{ 0, &asn_PER_type_rateMatchPatternToAddModList_constr_29, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_rateMatchPatternToReleaseList_31 = {
	...
	{ 0, &asn_PER_type_rateMatchPatternToReleaseList_constr_31, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_ServingCellConfigCommon_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct ServingCellConfigCommon, rateMatchPatternToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_rateMatchPatternToAddModList_constr_29,  memb_rateMatchPatternToAddModList_constraint_1 },
		0, 0, /* No default value */
		"rateMatchPatternToAddModList"
		},
	{ ATF_POINTER, 3, offsetof(struct ServingCellConfigCommon, rateMatchPatternToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_rateMatchPatternToReleaseList_constr_31,  memb_rateMatchPatternToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"rateMatchPatternToReleaseList"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommon, ss_PBCH_BlockPower),
		...
		0,
		{ 0, &asn_PER_memb_ss_PBCH_BlockPower_constr_35,  memb_ss_PBCH_BlockPower_constraint_1 },
		0, 0, /* No default value */
		"ss-PBCH-BlockPower"
		},
};
