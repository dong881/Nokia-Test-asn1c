...
asn_TYPE_descriptor_t asn_DEF_pusch_ServingCellConfig_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pusch_ServingCellConfig_constr_8, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_carrierSwitching_11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_carrierSwitching_constr_11, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_uplinkChannelBW_PerSCS_List_17 = {
	...
	{ 0, &asn_PER_type_uplinkChannelBW_PerSCS_List_constr_17, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_15[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UplinkConfig__ext1, uplinkChannelBW_PerSCS_List),
		...
		0,
		{ 0, &asn_PER_memb_uplinkChannelBW_PerSCS_List_constr_17,  memb_uplinkChannelBW_PerSCS_List_constraint_15 },
		0, 0, /* No default value */
		"uplinkChannelBW-PerSCS-List"
		},
};
