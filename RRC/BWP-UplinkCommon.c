...
asn_TYPE_descriptor_t asn_DEF_rach_ConfigCommon_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_rach_ConfigCommon_constr_3, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_pusch_ConfigCommon_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pusch_ConfigCommon_constr_6, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_pucch_ConfigCommon_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pucch_ConfigCommon_constr_9, CHOICE_constraint },
