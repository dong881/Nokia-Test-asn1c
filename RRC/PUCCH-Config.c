...
asn_TYPE_descriptor_t asn_DEF_format1_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_format1_constr_10, CHOICE_constraint },
	asn_MBR_format1_10,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_format2_13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_format2_constr_13, CHOICE_constraint },
	asn_MBR_format2_13,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_format3_16 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_format3_constr_16, CHOICE_constraint },
	asn_MBR_format3_16,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_format4_19 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_format4_constr_19, CHOICE_constraint },
	asn_MBR_format4_19,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_schedulingRequestResourceToAddModList_22 = {
	...
	{ 0, &asn_PER_type_schedulingRequestResourceToAddModList_constr_22, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_schedulingRequestResourceToReleaseList_24 = {
	...
	{ 0, &asn_PER_type_schedulingRequestResourceToReleaseList_constr_24, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_multi_CSI_PUCCH_ResourceList_26 = {
	...
	{ 0, &asn_PER_type_multi_CSI_PUCCH_ResourceList_constr_26, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dl_DataToUL_ACK_28 = {
	...
	{ 0, &asn_PER_type_dl_DataToUL_ACK_constr_28, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_spatialRelationInfoToAddModList_30 = {
	...
	{ 0, &asn_PER_type_spatialRelationInfoToAddModList_constr_30, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_spatialRelationInfoToReleaseList_32 = {
	...
	{ 0, &asn_PER_type_spatialRelationInfoToReleaseList_constr_32, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_PUCCH_Config_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct PUCCH_Config, schedulingRequestResourceToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_schedulingRequestResourceToAddModList_constr_22,  memb_schedulingRequestResourceToAddModList_constraint_1 },
		0, 0, /* No default value */
		"schedulingRequestResourceToAddModList"
		},
	{ ATF_POINTER, 6, offsetof(struct PUCCH_Config, schedulingRequestResourceToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_schedulingRequestResourceToReleaseList_constr_24,  memb_schedulingRequestResourceToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"schedulingRequestResourceToReleaseList"
		},
	{ ATF_POINTER, 5, offsetof(struct PUCCH_Config, multi_CSI_PUCCH_ResourceList),
		...
		0,
		{ 0, &asn_PER_memb_multi_CSI_PUCCH_ResourceList_constr_26,  memb_multi_CSI_PUCCH_ResourceList_constraint_1 },
		0, 0, /* No default value */
		"multi-CSI-PUCCH-ResourceList"
		},
	{ ATF_POINTER, 4, offsetof(struct PUCCH_Config, dl_DataToUL_ACK),
		...
		0,
		{ 0, &asn_PER_memb_dl_DataToUL_ACK_constr_28,  memb_dl_DataToUL_ACK_constraint_1 },
		0, 0, /* No default value */
		"dl-DataToUL-ACK"
		},
	{ ATF_POINTER, 3, offsetof(struct PUCCH_Config, spatialRelationInfoToAddModList),
		...
		0,
		{ 0, &asn_PER_memb_spatialRelationInfoToAddModList_constr_30,  memb_spatialRelationInfoToAddModList_constraint_1 },
		0, 0, /* No default value */
		"spatialRelationInfoToAddModList"
		},
	{ ATF_POINTER, 2, offsetof(struct PUCCH_Config, spatialRelationInfoToReleaseList),
		...
		0,
		{ 0, &asn_PER_memb_spatialRelationInfoToReleaseList_constr_32,  memb_spatialRelationInfoToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"spatialRelationInfoToReleaseList"
		},
