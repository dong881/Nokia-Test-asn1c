...
asn_TYPE_descriptor_t asn_DEF_beamCorrespondence_21 = {
	...
	{ 0, &asn_PER_type_beamCorrespondence_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_twoPortsPTRS_DL_70 = {
	...
	{ 0, &asn_PER_type_twoPortsPTRS_DL_constr_70, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_MIMO_ParametersPerBand_1[] = {
	...
	{ ATF_POINTER, 12, offsetof(struct MIMO_ParametersPerBand, maxNumberCSI_RS_BFR),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberCSI_RS_BFR_constr_67,  memb_maxNumberCSI_RS_BFR_constraint_1 },
		0, 0, /* No default value */
		"maxNumberCSI-RS-BFR"
		},
	{ ATF_POINTER, 11, offsetof(struct MIMO_ParametersPerBand, maxNumberSSB_BFR),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSSB_BFR_constr_68,  memb_maxNumberSSB_BFR_constraint_1 },
		0, 0, /* No default value */
		"maxNumberSSB-BFR"
		},
	{ ATF_POINTER, 10, offsetof(struct MIMO_ParametersPerBand, maxNumberCSI_RS_SSB_BFR),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberCSI_RS_SSB_BFR_constr_69,  memb_maxNumberCSI_RS_SSB_BFR_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 6, offsetof(struct MIMO_ParametersPerBand, maxNumberSimultaneousSRS_PerCC),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNumberSimultaneousSRS_PerCC_constr_75,  memb_maxNumberSimultaneousSRS_PerCC_constraint_1 },
		0, 0, /* No default value */
